...
?>
               <div class="row">
                   ...
                   <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                	<h4 class="m-t-2 header-title"><b>Management Details</b></h4>
                                	<div class="row">
                        				<div class="col-md-12">
	                                            ...
	                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" name="adesc" id="adesc"  class="form-control" placeholder="Position.....">
                                                    </div>
                                                </div>
	                                             <div class="form-group">
                                                                <div class="col-sm-4 col-md-offset-2">
                                                                <label class="control-label"></label>
                                                                <input type="file" class="filestyle" data-buttontext="Select file" data-buttonname="btn-default" id="image" name="image">
                                                                </div>
                                   ...
                                   <img src="uploads/images.png" width="200px" height="auto" id="imgpreview" />
                                                       ...
                                                       <button class="btn btn-info waves-effect w-md waves-light" type="Submit" name="action" onclick="addabout(this)" id="action">Add</button>
                                                        <button class="btn btn-info waves-effect w-md waves-light" type="Submit" onclick="updateabout(this);"  name="action" id="update">update</button>
                                                    </div>
	                    ...
	                    <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="m-t-0 header-title"><b>Details Table</b></h4>
 ...
 alert(obj.result);
    ...
    function updateabout(obj){
      if ($('#aname').val() == '') {
          ...
          var formData = new FormData();
          formData.append("op","updateabout");
          formData.append("aname",$('#aname').val());
          formData.append("adesc",$('#adesc').val());
            ...
            // alert(obj.data[n].col-xs-12status);
              ...
              if(obj.err==0)
              {
                ...
                for(n in obj.data){
                  code = code + '<tr>'+
                              '<td>'+(parseInt(n)+1)+'</td>'+
                              '<td> <img src=\"<?php echo  'uploads/aboutimage/'; ?>'+obj.data[n].image+'?'+Math.random()+'\" width="120px" height="auto" /> </td>'+
      ...
      $.ajax({
          ...
          success:function(result)
          {
              ...
              if (obj.err == 0) {
                ...
                $('#update').show();
                $('#action').hide();
                $('#imgpreview').attr('src','<?php echo 'uploads/aboutimage/'; ?>'+obj.image);
...
//                $('#imgpreview').attr('src',getBase64Image(document.getElementById("imgpreview"),obj.logo.substr((obj.logo.indexOf('.')+1),obj.logo.length)));
    ...
    function deleteTabEle(obj){
      var formData = new FormData();
      formData.append("op","deleteabout");
      formData.append("id",$(obj).attr('data-id'));
      $.ajax({
          url : 'ajax/abouthandler.php',    
          type : 'POST',
